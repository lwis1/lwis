...
const ProfileScreen = ({ location, history }) => {
  ...
  return (
    ...
    <br></br>
    <Row style={{display: "flex", justifyContent: "center",backgroundColor:"#E5E8E8",borderRadius:"30px" ,padding:"0",margin:"0"}}>
      <Col md={4} >
      <br /> <br/>
      <h2>User Profile</h2>
      <br /> 
      ...
      <Form onSubmit={submitHandler}>
        <Form.Group controlId='name'>
          <Form.Label  style={{ display: "flex",color:"rgb(48, 2, 21)", fontSize:"1.2rem"}}>Name :</Form.Label>
          <Form.Control
            type='name'
        ...
        <Form.Group controlId='email'>
          <Form.Label  style={{ display: "flex",color:"rgb(48, 2, 21)", fontSize:"1.2rem"}}>Email Address :</Form.Label>
          <Form.Control
            type='email'
        ...
        <Form.Group controlId='password'>
          <Form.Label style={{ display: "flex",color:"rgb(48, 2, 21)", fontSize:"1.2rem"}}>Password :</Form.Label>
          <Form.Control
            type='password'
        ...
        <Form.Group controlId='confirmPassword'>
          <Form.Label style={{ display: "flex",color:"rgb(48, 2, 21)", fontSize:"1.2rem"}}>Confirm Password :</Form.Label>
          <Form.Control
            type='password'
        ...
        <i class="fas fa-upload"> Update </i>
        </Button>
        ...
        {loadingOrders ? (
          ...
          <Table striped bordered hover responsive className='table-sm'style={{borderCollapse: "separate",borderSpacing:"0 5px"}} >
            <thead style={{backgroundColor:"orange" }}>
              <tr >
                <th style={{backgroundColor:"white" }}><i class="fas fa-id-card-alt" > order id</i></th>
